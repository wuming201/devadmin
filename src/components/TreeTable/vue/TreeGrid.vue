<template>
  <el-table
    ...
    <el-table-column label="操作" v-if="treeType === 'normal'" width="260">
      <template scope="scope">
        <button type="button" class="el-button el-button--default el-button--small" @click="edit(scope.row)">
          <!-- <router-link
        ...
        <el-button
          size="small"
          type="danger"
          @click="handleDelete(scope.row)" v-if="!scope.row.children || scope.row.children.length==0">
          删除 
        </el-button>
