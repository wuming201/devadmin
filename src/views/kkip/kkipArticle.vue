<template>
  <div class="app-container">
    <div class="memberHead">
      <p><router-link to="/kkip/kk-article-index"><el-button type="primary">&emsp;首页&emsp;</el-button></router-link>
        <router-link to="/kkip/kk-article-YTLR"><el-button type="danger" >幼体联人</el-button></router-link>
        <router-link to="/kkip/kk-article-Type"><el-button type="success">文章类型</el-button></router-link>
        <router-link to="/kkip/kk-article-Send"><el-button type="warning" @click="addMember">发布文章</el-button></router-link></p>
    </div>
    <el-table
      ref="multipleTable"
      :data="alData"
