<template>
  <div class="addMember">
    <div class="memberInfo">
      ...
      <p class="pic"><span><span class="title">证书图片:</span><span class="pics"><img :src="newData.oldCer" alt=""></span></span><span><span class="title">寸照:</span><span class="pics"><img :src="newData.identityUrl" alt=""></span></span></p>
