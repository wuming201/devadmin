<template>
  <div class="schoolInfo">
    <div class="memberInfo">
      ...
      <p><span><span class="title">幼儿园简称:</span><span class="innerText"><el-input v-model="scontractId"></el-input></span></span><span><span class="title">创建者ID:</span><span class="innerText"><el-input v-model="susername"></el-input></span></span></p>
      ...
      <p class="address"><span><span class="title">幼儿园地址:</span><el-input class="city" placeholder="城市" v-model="stelphone"></el-input><el-input class="info" placeholder="详细地址" v-model="susername"></el-input></span></p>
...
export default {
  ...
  methods: {
    ...
    save1() {
      var _this = this
      PUBLIC.get("User.Mechanism.Melist",{user_phone:this.stelphone},function(data){
        if(data.length>0){
          _this.phoneStatusText="手机号已存在"
          PUBLIC.toa("手机号已存在")
        }else{
          data = { pro: _this.selectedOptions[0], city: _this.selectedOptions[1], county: _this.selectedOptions[2], name:_this.sname, user_phone:_this.stelphone,username:_this.susername,img:"[]",contract_num:_this.scontractId,contract_doc:_this.scontractFile, auth_dir: _this.checkedAuthorize}
          console.log(data)
          PUBLIC.get("User.Mechanism.Addauth",data, function(data){
            console.log(data)
            _this.$router.go(-1)
          })
        }
