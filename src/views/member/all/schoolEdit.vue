<template>
  <div class="schoolInfo">
    <div class="memberInfo">
      <p class="name"><span><span class="title">幼儿园名称:</span><el-input v-model="sname" v-if="company_statu == 0" ></el-input><el-input v-model="sname" v-else disabled></el-input></span></p>
      <p><span><span class="title">幼儿园简称:</span><span class="innerText"><el-input
      ...
      <p><span><span class="title">联系电话:</span><span class="innerText"><el-input v-model="company_phone"></el-input></span>{{phoneStatusText}}</span>
        <span><span class="title">负责人:</span><span class="innerText"><el-input
          v-model="company_user"></el-input></span></span></p>
      <p class="address"><span><span class="title">幼儿园地址:</span><el-input class="city" placeholder="城市"
