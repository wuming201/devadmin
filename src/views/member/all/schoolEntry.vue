<template>
  <div class="schoolInfo">
    <div class="memberInfo">
      ...
      <p><span><span class="title">幼儿园简称:</span><span class="innerText"><el-input v-model="scontractId"></el-input></span></span><span><span class="title">创建者ID:</span><span class="innerText"></span></span></p>
