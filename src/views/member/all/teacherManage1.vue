<template>
  <div class="app-container">
    <div class="memberHead">
      ...
      <p><span class="buttons"><el-button type="primary">全选</el-button><router-link to="/member/teacher-manage"><el-button type="danger">全部老师</el-button></router-link>
      </span>
        <searchBox @searchKey='searchLike' @cleanIt='cleanIt' v-bind:searchSelect='searchSelect'></searchBox></span></p>
    </div>
    <el-table
      ref="multipleTable"
      :data="tableData3"
  ...
  export default {
    ...
    methods: {
      ...
      getTeacherList: function (keyword) {
        console.log(keyword)
        var _this = this
        var args = {page: this.page,videoProducing: "1"}
