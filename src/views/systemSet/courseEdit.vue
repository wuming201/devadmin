  ...
  <div class="addMember clearfix">
    <div class="memberInfo">
      ...
      <p class="addP"><span><span class="title">课程相册:</span>
        <span class="pics" v-html="morepic"></span><span class="addP" v-html="addPic"></span><span class="btn"><el-button type="primary" @click="upImg()">添加照片</el-button></span></span><el-input type='file' id='upimgs' v-on:change='upFile' hidden></el-input></p>
      <p><el-button type="primary" @click="editCourse">编辑</el-button><el-button type="info">取消</el-button></p>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      editCourse() {
        ...
        var value = JSON.stringify({name: this.lesson, pic: this.pic, pics: this.pics, link: this.links})
        console.log(value)
